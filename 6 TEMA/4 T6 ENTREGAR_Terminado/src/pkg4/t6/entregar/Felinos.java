 ...
 * @author Jesus
 */
public  class Felinos extends Animal{//Subclase que hereda los atributos con "extends" Super Clase: Animal
...
//    Constructores
    ...
    public Felinos(String nombre, int edad, int peso, String sonido, String alimentacion, String habitat, String nombreCientifico) {
