...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        menoramayor(n1, n2, n3, n4, auxiliar);
        
        
    }
    
    public static void menoramayor(int n1, int n2, int n3, int n4, int auxiliar) {
        ...
        //X3 veces
        //(Método Burbuja, ORDENA de Menor a MAYOR)
